            ...
            <?php
                while ($row = mysqli_fetch_row($result)) {
                    ...
                    foreach($row as $key => $value) {
                        ...
                        echo "<td class='img-review' val='".$row[0]."'><img href='#' class='img-thumbnail' style='max-height:50%;' src='$value'/></td>";
                        } elseif($i > 1){
                    ...
                    if($admin || !$user){
                      ...
                      if ($button_flag) {
                        ...
                        <button class="btn btn-warning" style="width:8em"> Kembalikan </button> </td>';
                        ...
                        <button class="btn btn-primary" style="width:8em"> Pinjam </button>
                        </form>
                        </td>';
                      } else {
                        echo '<td><button class="btn btn-primary disabled" style="width:8em"> Pinjam </button></td>';
                      }
                    }
                }
            ?>
